...
public class NamesOnGoogleMap implements CalculationResult {
    ...
    public void loadData(List<SimpleGeolocation> results) {
        results.forEach( c -> {
            String icon = "http://ws.clarin-pl.eu/public/icons/pin-1-10.png";
            if(c.getFreq() >= 10 && c.getFreq() < 100) icon = "http://ws.clarin-pl.eu/public/icons/pin-10-100.png";
            if(c.getFreq() >= 100 && c.getFreq() < 1000) icon = "http://ws.clarin-pl.eu/public/icons/pin-100-1000.png";
            if(c.getFreq() >= 1000) icon = "http://ws.clarin-pl.eu/public/icons/pin-1000.png";
